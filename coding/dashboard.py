...
# Load berkas                                   
day_clean_df = pd.read_csv("https://raw.githubusercontent.com/oktaagnes/bikeSharing/refs/heads/main/coding/data/dayDataSet.csv")
hour_df = pd.read_csv("https://raw.githubusercontent.com/oktaagnes/bikeSharing/refs/heads/main/coding/data/hourDataSet.csv")
...
with st.sidebar:
    st.text('Bike Rental')
    st.image("https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.vecteezy.com%2Ffree-vector%2Fbike-rental&psig=AOvVaw2tgU3RE_OLAYe2bzr8nyk7&ust=1734006753030000&source=images&cd=vfe&opi=89978449&ved=0CBQQjRxqFwoTCNCemNncn4oDFQAAAAAdAAAAABAE", caption='')
